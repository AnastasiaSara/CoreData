...
class AllArticleViewController: UIViewController {
   ...
   private let session = URLSession.shared
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let savedObjects = CoreDataManager.shared.fetchSelectedArticles()
        let savedTitles = savedObjects.map { $0.title }
...
extension AllArticleViewController: UITableViewDataSource, UITableViewDelegate {
...
extension AllArticleViewController {
